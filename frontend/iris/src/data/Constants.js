...
export const GITHUB_REPO = "https://github.com/glycojones/iris-validation";
...
export const COLUMNS = [
    ...
    },
    {
        ...
        accessor: 'svg',
        Cell: tableProps => {
            return _jsx("img", { src: `data:image/svg+xml;base64,${btoa(tableProps.row.original.svg)}`, alt: "", width: "300", height: "300" });
        }
    },
    {
        Header: 'GlytoucanID',
