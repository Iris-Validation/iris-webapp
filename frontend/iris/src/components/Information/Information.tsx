    ...
    return <div className="text-secondary bg-tertiary pb-12">
        <div className="flex flex-col">
            <div className="text-center sm:text-left sm:text-center mb-4 px-12 pt-12 sm:p-12 flex flex-col">
                ...
                Iris validation is a Python package created to represent comprehensive per-residue validation metrics for entire protein chains in a compact, readable and interactive view. </span>
            </div>
        </div>
    </div>;
}
