...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'iris.data';
      var REMOTE_PACKAGE_BASE = 'iris.data';
...
var REMOTE_PACKAGE_SIZE = metadata['remote_package_size'];
    ...
    function runWithFS() {
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_iris.data');

      };
      Module['addRunDependency']('datafile_iris.data');
    ...
    loadPackage({"files": [{"filename": "/5fjj.pdb", "start": 0, "end": 2721033}], "remote_package_size": 2721033});
...
if (Module['locateFile']) {
  ...
  wasmBinaryFile = new URL('iris.wasm', import.meta.url).href;
}
